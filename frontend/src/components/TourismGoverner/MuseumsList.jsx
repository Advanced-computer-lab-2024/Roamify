      ...
      <div className="flex flex-col gap-4 bg-white p-6 rounded-lg shadow-md w-full max-w-3xl">
        {museums.length === 0 ? (
          ...
          <ul className="museums-list">
            {museums.map((museum) => (
              <li
                key={museum._id} // Use _id instead of id
              ...
              >
                <div>
                  ...
                  <p>
                    Location:{" "}
                    {museum.location?.name || "Location not specified"}
                  </p>
                  <p>
                    Coordinates:{" "}
                ...
                <p>
                  Tags:{" "}
                  {Array.isArray(museum.tags)
                    ? museum.tags.map((tag) => tag.name).join(", ")
                    : "Tags not specified"}
                </p>
                ...
                <div className="flex gap-2">
                  <EditButton onClick={() => handleEdit(museum)}>
                    Edit
                  </EditButton>
                  <DeleteButton onClick={() => handleDelete(museum._id)}>
                    Delete
                  </DeleteButton>
                </div>
              </li>
