...
const EditActivityModal = ({ activity, onChange, onClose, refreshActivities }) => {
    useEffect(() => {
    ...
    const formattedSpecialDiscounts = activity.specialDiscounts ? String(activity.specialDiscounts) : '';
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            await axios.put(`http://localhost:3000/advertiser/update-activity/6703e6a0d578efd1cb6259e0/${activity._id}`, activity);
            ...
            <div className="modal-content bg-white p-6 rounded shadow-md w-full max-w-lg max-h-screen overflow-auto">
                ...
                <form onSubmit={handleUpdate}>
                    ...
                    <InputField
                        ...
                        type="text"
                        name="tags"
                        value={Array.isArray(activity.tags) ? activity.tags.join(', ') : ''} // Convert array to comma-separated string
                        onChange={onChange}
