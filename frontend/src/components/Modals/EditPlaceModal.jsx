                ...
                <form onSubmit={onUpdate}>
                    ...
                    <div className="mb-4">
                        ...
                        <InputField
                            ...
                            value={museum.location?.coordinates ? museum.location.coordinates[0] : ''} // Fallback value for longitude
                            onChange={(e) => {
                        ...
                        <InputField
                            ...
                            value={museum.location?.coordinates ? museum.location.coordinates[1] : ''} // Fallback value for latitude
                            onChange={(e) => {
                                const { value } = e.target;
                                onChange({
                                    target: {
                    ...
                    {/* Ticket Prices */}
                    <div className="mb-4">
                        <h3 className="text-sm font-medium text-gray-700 mb-1">Ticket Prices</h3>
                        <InputField
                    ...
                    <label className="flex flex-col mb-4">
                        ...
                        {museum.picture && (
                            <img
                                src={typeof museum.picture === 'string' ? museum.picture : URL.createObjectURL(museum.picture)}
                                alt="Place Preview"
