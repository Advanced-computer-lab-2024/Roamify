...
const TourismGovernorPage = () => {
  ...
  const handleTagAdd = (e) => {
    if (e.key === "Enter" && e.target.value.trim() !== "") {
      setCurrentPlace({
        ...currentPlace,
        tags: [...currentPlace.tags, e.target.value.trim()],
      });
      e.target.value = "";
    }
  };
  ...
  return (
    <div className="tourism-page">
      <div className="form">
        ...
        {currentPlace.picture && (
          <img
            src={URL.createObjectURL(currentPlace.picture)}
            alt="Preview"
            width="200"
          />
        )}
        ...
        <div className="prices">
          <input
            ...
            value={currentPlace.prices.foreigner}
            onChange={handleInputChange}
          />
          <input
            type="text"
            ...
            value={currentPlace.prices.native}
            onChange={handleInputChange}
          />
          <input
            type="text"
            ...
            value={currentPlace.prices.student}
            onChange={handleInputChange}
          />
        </div>
          ...
          <ul>
            {places.map((place, index) => (
              <li key={index}>
                ...
                {place.picture && (
                  <img
                    src={URL.createObjectURL(place.picture)}
                    alt={place.name}
                    width="200"
                  />
                )}
                ...
                <p>
                  Prices: Foreigner: {place.prices.foreigner}, Native:{" "}
                  {place.prices.native}, Student: {place.prices.student}
                </p>
