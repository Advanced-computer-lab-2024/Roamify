  ...
  return (
    <>
      <section id="theme_search_form_tour">
        <div className="container shadow-lg rounded p-4" style={{ width: '50%', background: 'var(--secondary-color)' }}>
                ...
                <form action="#!">
                  <div className="row">
                    <div className="col-lg-6 col-md-12 col-sm-12 col-12">
                      <div className="flight_Search_boxed" style={{width:"100%"}}>
                        <p style={{fontSize:"25px"}}>City</p>
                        <select
                          value={cityCode}
      ...
      <div className="flight_search_result_wrapper" style={{flexDirection:"column"}}>
                  {hotels.length > 0 ? (
