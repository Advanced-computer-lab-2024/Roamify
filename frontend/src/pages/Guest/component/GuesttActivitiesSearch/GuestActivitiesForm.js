...
import GuestCategoryActivity from './GuestCategoryActivities.js';
import axios from 'axios';
import GuestActivitiesArea from './index.js';

const GuestActivitiesForm = () => {
            ...
            {activeTab && (
              <div className="tab-content">
                {categories.map((category) => (
                  ...
                  >
                    <GuestCategoryActivity categoryId={category._id} />
                  </div>
                ))}
              </div>
            )}
...
export default GuestActivitiesForm;
