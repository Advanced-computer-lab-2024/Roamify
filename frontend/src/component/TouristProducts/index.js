              ...
              <div className="left_side_search_area">
                ...
                <div className="left_side_search_heading">
                  ...
                  <select value={order} onChange={handleOrderChange}>
                    <option value="asc" className="apply">Low to High</option>
                    <option value="desc" className="apply">High to Low</option>
                  </select>
                </div>
              </div>
                <div className="left_side_search_boxed">
              ...
              {loading ? (
                ...
                products.map((product) => (
                  <div className="col-md-4" key={product._id}>
                    <CommonCard
                      id={product._id}
                      picture={product.picture.length > 0 ? product.picture[0] : productDefault}
                      name={product.name}
